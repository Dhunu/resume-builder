...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2  disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-indigo-300 to-purple-300 text-white dark:from-indigo-500 dark:to-purple-500 hover:from-indigo-400 hover:to-purple-400 hover:dark:from-indigo-700 hover:dark:to-purple-700 transition-all duration-700",
        destructive:
